...
(error) => {
  ...
  startTypingSound(): void {
    ...
    this.soundInterval = setInterval(() => {
      this.audioService.play('https://find-it-genious.onrender.com/public/audio/type.mp3','SFX');
    }, interval);
  ...
  stopTyping(): void {
    if (this.soundInterval) {
      clearInterval(this.soundInterval);
       this.audioService.stop('https://find-it-genious.onrender.com/public/audio/type.mp3');
    }
  }
