...
export class AudioService {
  ...
  constructor(@Inject(PLATFORM_ID) private platformId: Object) { // Precarica gli audio più utilizzati
   this.preloadAudio('http://localhost:3000/public/audio/type.mp3', 'SFX');
   this.preloadAudio('http://localhost:3000/public/audio/found.mp3', 'SFX');
   this.preloadAudio('http://localhost:3000/public/audio/hint.mp3', 'SFX');
   this.preloadAudio('http://localhost:3000/public/audio/button.mp3', 'SFX');
   this.preloadAudio('http://localhost:3000/public/audio/buttonHover.mp3', 'SFX');
   this.preloadAudio('http://localhost:3000/public/audio/levelMusic.mp3', 'BGMusic');
  }
